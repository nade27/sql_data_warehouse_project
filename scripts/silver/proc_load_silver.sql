/*
=============================================================================
Stored Proceduure: Load Silver Layer (Bronze -> Silver)
=============================================================================
Script Purpose:
...
BEGIN
	...
	PRINT '>> Inserting Data Infor: silver.crm_cust_info';
	...
	PRINT '>> Inserting Data Infor: silver.crm_prd_info';
	...
	PRINT '>> Inserting Data Infor: silver.crm_sales_details';
	...
	PRINT '>> Inserting Data Infor: silver.erp_cust_az12';
	...
	PRINT '>> Inserting Data Infor: silver.erp_loc_a101';
	
	PRINT '----------------------------------------------';
	
	INSERT
			INTO
			silver.erp_loc_a101 (cid,
			cntry)
	...
	PRINT '>> Inserting Data Infor: silver.erp_px_cat_g1v2';
